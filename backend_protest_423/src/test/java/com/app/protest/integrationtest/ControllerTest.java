package com.app.protest.integrationtest;
...
import com.app.protest.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("protest", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/protest/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/protest/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM protest.PetService");
    jdbcTemplate.execute("DELETE FROM protest.PetOwner");
    jdbcTemplate.execute("DELETE FROM protest.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM protest.Manager");
    jdbcTemplate.execute("DELETE FROM protest.Document");
    jdbcTemplate.execute("DELETE FROM protest.Pet");
     jdbcTemplate.execute("DELETE FROM protest.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM protest.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM protest.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM protest.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM protest.PetCareCenterPets");
